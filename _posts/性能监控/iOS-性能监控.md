...
如果需要业务方自己书写代码，这一点非常麻烦。最好能做到无痕接入，尽可能通用、可配置。
...
特别是当一个列表页大部分情况下很流畅，但是只在一瞬间掉一两帧，这种情况直接用 Instruments 很难分析出需要优化的地方。
...
**日志传输** 在 pc 搭建了一个服务器，监控系统内部提供连接该服务器传输文件、流的能力。
